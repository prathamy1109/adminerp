                    ...
                    <div class="app-main__inner">
                        ...
                        <button class="close"></button>
                         ...
                         <div class="main-card mb-3 card">
                            <div class="card-body">
                                <h5 class="card-title">Add Courier Receive </h5>
                                        ...
                                        <div class="table-responsive">
                                            <table class="mb-0 table">
                                                ...
                                                <tbody>
                                                    ...
                                                    if(!empty($courier_receive_list)) 
                                                    {    

                                                    foreach ($courier_receive_list as $key => $value) 
                                                        {
                                                        ...
                                                        ?>
                                                                    ...
                                                                    <tr>
                <td scope="row"><?php echo !empty($value->cr_id)?$value->cr_id:""; ?></td>
                <td><?php echo !empty($value->cr_totitle)?$value->cr_totitle:""; ?> </td>
                <td><?php echo !empty($value->cr_reference)?$value->cr_reference:""; ?> </td>
                <td><?php echo !empty($value->cr_address)?$value->cr_address:""; ?> </td>
                <td><?php echo !empty($value->cr_note)?$value->cr_note:""; ?> </td>
                <td><?php echo !empty($value->cr_fromtitle)?$value->cr_fromtitle:""; ?> </td>
                <td><?php echo !empty($value->cr_date)?$value->cr_date:""; ?> </td>
                <td><?php echo !empty($value->cr_attach)?$value->cr_attach:""; ?> </td>
