                            ...
                            <div class="tab-pane tabs-animation fade show active" id="tab-content-0" role="tabpanel">
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="main-card mb-3 card">
                                            <div class="card-body"><!-- <h5 class="card-title">Add Expenses Head</h5> -->
                                ...
                                'autocomplete' => 'off']); ?>
                                                ...
                                                <form class="">
                                                     ...
                                                     <label for="validationCustom02"><h5 class="card-title">Add Religion </h5></label>
                                            <input type="text" class="form-control" id="religion_name" 
                                           name="religion_name" placeholder="Enter Religion" value="">
                                           ...
                                           <!--  <label for="validationCustom02">Description </label>
                                            <input type="text" class="form-control" id="validationCustom02" placeholder="Add Description" value="" required> -->
                                            <!-- <div class="invalid-feedback">
                                                    Please Enter Last Name.
                                                </div> -->

                                                  <!--   <div class="position-relative form-group"><label for="exampleEmail" class="">Add Expenses </label><input name="email" id="exampleEmail" placeholder="Enter Expenses" type="email" class="form-control"></div> -->
                                                   <!--  <div class="position-relative form-group"><label for="examplePassword" class="">Description </label><input name="password" id="examplePassword" placeholder="Description " type="password"
                                                    ...
                                                    <div class="position-relative form-group"><label for="exampleText" class="">Description</label><textarea name="text" id="exampleText" class="form-control"></textarea></div> -->
                                ...
                                <a href="<?php echo base_url('add-religion'); ?>"> <button type="button" class="btn btn-danger waves-effect w-md waves-light m-b-5">Cancel</button> </a>
                                    ...
                                    <div class="col-lg-8">
                                <div class="main-card mb-3 card">
                                     <div class="card-body"><h5 class="card-title">Religion List</h5>
                                    <hr>
                                    <div class="text-right m-b-10 SearchInput">
                                      <label for="search"><b>Search: </b></label>
                                      <input type="text" name="search_term" id="search_term" value="">
                                      <span class="SearchI"><button type="submit"><i class="fa fa-search"></i></button></span>
                                    </div>
                                    <div class="card-body">
                                        <div class="table-responsive">
                                            <table class="mb-0 table">
                                                ...
                                                <tbody>
                                                    <?php 
                                                    if(!empty($Add_religion_list))
                                                    {
                                                    foreach ($Add_religion_list as $key => $value) {
                                                        
                                                    ?>
                                                <tr>
                    <td scope="row"><?php echo !empty($value->mr_id)?$value->mr_id:""; ?></td>
                    <td><?php echo !empty($value->mr_religion_name)?$value->mr_religion_name:""; ?></td>
                                  ...
                                  <!--   <div class="col-md-6">
                                        <div class="main-card mb-3 card">
                                            <div class="card-body"><h5 class="card-title">List Of Expenses</h5>
